...
def dynamic_firstfit_EXEC(file_name, with_compaction):
    ...
    for job_index in range(len(arrival_time)):
        ...
        if len(waiting) != 0:
            ...
            for w in waiting:
                ...
                if len(fits) != 0:
                    ...
                    Ploc.append(Floc[Fs.index(first_fit)])
                    ...
                    Floc[Fs.index(first_fit)] += job_size[w]
                    Fs[Fs.index(first_fit)] -= job_size[w]
        ...
        if len(fits) != 0:
            ...
            Floc[Fs.index(first_fit)] += job_size[job_index]
            Fs[Fs.index(first_fit)] -= job_size[job_index]
    ...
    print()
    print(f'Dynamic First Fit, compaction = {with_compaction}')
